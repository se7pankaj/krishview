...
export class MlService {
  ...
  private flattenFeatures(f: FeatureSet, direction: 'BUY' | 'SELL'): Record<string, number> {
    ...
    return {
      ...
      htf_bias:             htfBias,
      htf_ema_aligned:      f.htfTrend.aligned ? 1 : 0,
      htf_ema200_dist:      f.htfTrend.ema200Distance,
      ltf_ema_aligned:      f.ltfTrend.aligned ? 1 : 0,
      ltf_ema200_dist:      f.ltfTrend.ema200Distance,
      rsi:                  f.momentum.rsi,
